...
export const i18n: Record<LangCode, Translation> = {
  cs: {
    ...
    welcomeHint: "Stiskněte OK (Enter)",
    menuTitle: "Menu",
  ...
  en: {
    ...
    receptionUpdate: "Update from reception",
    groupLabel: "Group",
